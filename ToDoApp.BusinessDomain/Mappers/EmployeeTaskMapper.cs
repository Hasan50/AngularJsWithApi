    ...
    public static class EmployeeTaskMapper
    {
        ...
        public static List<TaskGroupModel> ToTaskGroup(DbDataReader readers)
        {
            ...
            while (readers.Read())
            {
                var model = new TaskGroupModel
                {
                    ...
                    TotalTask= Convert.IsDBNull(readers["TotalTask"]) ? (int?)null : Convert.ToInt32(readers["TotalTask"]),
        ...
        public static List<TaskModel> ToTask(DbDataReader readers)
        {
            ...
            while (readers.Read())
            {
                ...
                model.DueDateVw = model.DueDate.HasValue ? model.DueDate.Value.ToString(Constants.DateFormat) : string.Empty;
