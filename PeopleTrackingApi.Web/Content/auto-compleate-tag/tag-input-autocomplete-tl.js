...
angular.module('tagInAuTl', []).directive('tagInAuTl', function () {
    return {
        ...
        '<div class=\'input-tag animatedTag flipInXTag\' data-ng-repeat="tag in tagArrayListSetView() track by $index"><span>{{tag}}</span><div class=\'delete-tag\' data-ng-click=\'deleteTag($index)\'>&times;</div>' + '</div>' +
        '<input type=\'text\' data-ng-model=\'tagText\' placeholder="Search Company" />' +
        '</div>' +
